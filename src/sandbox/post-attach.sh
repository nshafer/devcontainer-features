...
# this window's set already -- it sweeps every second, and the sockets appear during the connect
# handshake -- so this is here to confirm that from the one vantage point that can, and to be loud
# if it did not.
#
